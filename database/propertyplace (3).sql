...
--
-- Host: localhost:3306
-- Waktu pembuatan: 16 Agu 2025 pada 13.13
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
INSERT INTO `komisi_sales` (`id`, `booking_id`, `user_id`, `komisi_persen`, `komisi_nominal`, `status`, `tanggal_ajuan`, `tanggal_acc`, `catatan`, `created_at`, `updated_at`) VALUES
